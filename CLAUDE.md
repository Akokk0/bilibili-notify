...
- `subscriptions.md` —— 订阅:B 站 / 拓展两支与两个文件、身份 vs 订阅 id 两种键、资料与头像、订阅源拓展(清单 / 契约小号 / 解析门 / 上报的丢格与拒收)
...
- `extension-marketplace.md` —— 拓展市场:官方索引怎么签、怎么发(`extension/<id>@<ver>` tag),第三方怎么自己开一个源,id 的命名空间规矩
