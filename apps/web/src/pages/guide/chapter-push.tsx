...
export function ChapterPush() {
	return (
		<div>
			...
			<GdP>
				走腾讯官方 Bot 接口,不碰你的 QQ 账号、零风控风险、零额外部署。代价是能力受官方限制, 且
				<b>按 bot 等级分层</b>:扫码一键建的轻量 bot 目前可推创建者私聊与创建者当群主的群; 过审
				bot、企业主体逐级放宽 —— 以官方最新政策为准。
			</GdP>
			...
			<WarnNote className="mb-2">
				轻量 bot 的边界:无审核环节,能力目前限创建者私聊与创建者当群主的群(以官方政策为准); 每个 QQ
				号最多创建 5 个;凭据丢了重新扫码可找回(可重选已建的 bot 重发密钥)。 要更宽的能力走 A2
				正式注册或路线 B。
			</WarnNote>
